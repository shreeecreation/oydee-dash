...
abstract class $PaginationModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int totalItems, int? page, bool hasNextPage});
}
...
class _$PaginationModelImpl implements _PaginationModel {
  const _$PaginationModelImpl(
      {required this.totalItems, this.page, required this.hasNextPage});
  ...
  @override
  String toString() {
    return 'PaginationModel(totalItems: $totalItems, page: $page, hasNextPage: $hasNextPage)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, totalItems, page, hasNextPage);
...
abstract class _PaginationModel implements PaginationModel {
  const factory _PaginationModel(
      ...
      final int? page,
      required final bool hasNextPage}) = _$PaginationModelImpl;
